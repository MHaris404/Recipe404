...
class RecipeDetailsViewModelTest {
    ...
    fun test_success() = runTest {
        ...
        viewModel.onEvent(
            com.mharis404.search.screens.details.RecipeDetails.Event.FetchRecipeDetails(
                "id"
            )
        )
    ...
    fun test_navigate_recipe_list_screen() = runTest {
        ...
        viewModel.onEvent(com.mharis404.search.screens.details.RecipeDetails.Event.GoToRecipeListScreen)
        val list = mutableListOf<com.mharis404.search.screens.details.RecipeDetails.Navigation>()
        ...
        assert(list.first() is com.mharis404.search.screens.details.RecipeDetails.Navigation.GoToRecipeListScreen)
    ...
    fun test_navigate_goToMediaPlayer() = runTest {
        ...
        viewModel.onEvent(com.mharis404.search.screens.details.RecipeDetails.Event.GoToMediaPlayer("url"))
        val list = mutableListOf<com.mharis404.search.screens.details.RecipeDetails.Navigation>()
        backgroundScope.launch(UnconfinedTestDispatcher()) {
            viewModel.navigation.collectLatest {
                list.add(it)
        ...
        assert(list.first() is com.mharis404.search.screens.details.RecipeDetails.Navigation.GoToMediaPlayer)
    ...
    fun test_insert() = runTest {
        ...
        viewModel.onEvent(
            com.mharis404.search.screens.details.RecipeDetails.Event.InsertRecipe(
                getRecipeDetails()
            )
        )
    ...
    fun test_delete() = runTest {
        ...
        viewModel.onEvent(
            com.mharis404.search.screens.details.RecipeDetails.Event.DeleteRecipe(
                getRecipeDetails()
            )
        )
